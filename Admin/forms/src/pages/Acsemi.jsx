...
//     const [type, setType] = useState('2+2 AC Semi Sleeper');

//     const fetchBuses = async () => {
//         try {
//             const res = await axios.get('http://localhost:5001/api/acsleeper/semi');
//             setBuses(res.data);
//         } catch (error) {
...
//             type,
//             duration,
//             boardingPoints: parsePoints(boardingPoints),
//             droppingPoints: parsePoints(droppingPoints),
//         };

//         try {
//             if (editingBus) {
//                 await axios.post(`http://localhost:5001/api/acsleeper/semi/update/${editingBus._id}`, busData);
//                 alert('Bus updated successfully!');
//             } else {
//                 await axios.post('http://localhost:5001/api/acsleeper/semi', busData);
...
//         // Ensure boardingPoints and droppingPoints are always arrays
...
//             try {
//                 await axios.delete(`http://localhost:5001/api/acsleeper/semi/${id}`);
//                 fetchBuses();
...
//         setBoardingPoints([]);
//         setDroppingPoints([]);
//         setType('2+2 AC Semi Sleeper');
//     };

//     return (
//         <div style={{ padding: '20px' }}>
//             <h2>2+2 AC Semi Sleeper Buses</h2>
...
//                     <input type="text" placeholder="Duration (e.g., 5 hrs 30 mins)" value={duration} onChange={(e) => setDuration(e.target.value)} required />
...
//                                 placeholder="Name"
//                                 value={bp.name}
//                                 onChange={e => handleBoardingChange(i, 'name', e.target.value)}
//                                 required
//                             />
//                             <input
//                                 type="time"
//                                 value={bp.time}
//                                 onChange={e => handleBoardingChange(i, 'time', e.target.value)}
//                                 required
//                             />
//                         </div>
//                     ))}
//                     <button type="button" onClick={() => setBoardingPoints([...boardingPoints, { id: Date.now(), name: '', time: '' }])}>
//                         + Add Boarding Point
//                     </button>
...
//                                 placeholder="Name"
//                                 value={dp.name}
//                                 onChange={e => handleDroppingChange(i, 'name', e.target.value)}
//                                 required
//                             />
//                             <input
//                                 type="time"
//                                 value={dp.time}
//                                 onChange={e => handleDroppingChange(i, 'time', e.target.value)}
//                                 required
//                             />
//                         </div>
//                     ))}
//                     <button type="button" onClick={() => setDroppingPoints([...droppingPoints, { id: Date.now(), name: '', time: '' }])}>
//                         + Add Dropping Point
//                     </button>
...
//                                         <div key={i}>{bp.name} - {bp.time}</div>
//                                     ))}
//                                 </td>
//                                 <td>
//                                     {bus.droppingPoints?.map((dp, i) => (
//                                         <div key={i}>{dp.name} - {dp.time}</div>
//                                     ))}
//                                 </td>
//                                 <td>
        ...
        <div style={{ padding: '20px' }}>
            ...
            {isFormVisible && (
                <form onSubmit={handleSubmit} className="bus-form">
                    ...
                    <input type="number" placeholder="TotalSeats" value={Totalseats} onChange={e => setTotalSeats(e.target.value)} required />
                    ...
                    <tbody>
                        {buses.map((bus) => (
                            <tr key={bus._id}>
                                ...
                                <td>{bus.from}</td>
                                <td>{bus.to}</td>
                                <td>{bus.dateOfDeparture.slice(0, 10)}</td>
                                <td>{bus.dateOfArrival.slice(0, 10)}</td>
                                ...
                                <td>{bus.seatsAvailable}</td>
                                <td>
                                    <button onClick={() => handleEdit(bus)}>Update</button>
                                    <button onClick={() => handleDelete(bus._id)}>Delete</button>
                                </td>
                            </tr>
                        ))}
